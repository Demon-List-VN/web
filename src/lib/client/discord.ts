...
export const DISCORD_BOT_INVITE_URL = `https://discord.com/oauth2/authorize?${new URLSearchParams({
...
export const DISCORD_OAUTH_URL = `https://discord.com/oauth2/authorize?${new URLSearchParams({
	client_id: DISCORD_CLIENT_ID,
	response_type: 'code',
...
export const DISCORD_COMMANDS: DiscordCommand[] = [
	...
	},
	{
		...
		params: [{ name: 'query', descriptionKey: 'discord_bot.params.level_query', required: true }]
	},
	{
		name: '/record',
		group: 'records',
		...
		params: [
			...
			{ name: 'user', descriptionKey: 'discord_bot.params.discord_user', required: false },
			{ name: 'query', descriptionKey: 'discord_bot.params.player_query', required: false },
			{ name: 'variant', descriptionKey: 'discord_bot.params.record_variant', required: false }
		]
	},
	{
		name: '/recent',
