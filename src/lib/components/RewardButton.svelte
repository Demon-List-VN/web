<script lang="ts">
	...
	$: borderOpacity = !editable && (isPremiumLocked || shouldReduceOpacity)
		? 0.3
		: 1;
    ...
    <Popover.Trigger asChild let:builder>
      ...
      >
        ...
        {:else if isClaimable && showGiftIcon}
          <div class="absolute inset-0 left-1 top-1 z-20 h-fit w-fit items-center justify-center rounded-xl bg-green-500/50 p-1 pl-[4px]">
