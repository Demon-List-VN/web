	...
	<div class="fixed inset-0 z-[9999] flex items-center justify-center p-4" role="presentation">
		...
		>
				...
				<div class="space-y-4">
					...
					<div class="space-y-3">
						<div class="flex items-center gap-3">
							...
							<Input
								bind:value={youtube}
								placeholder={$_('onboarding.social_youtube_placeholder')}
							/>
						</div>
						<div class="flex items-center gap-3">
							...
							<Input
								bind:value={facebook}
								placeholder={$_('onboarding.social_facebook_placeholder')}
							/>
						</div>
					</div>
					<div class="flex gap-2">
					...
					<div class="grid grid-cols-2 gap-3">
						...
						<div class="rounded-xl border border-border p-4">
							...
							<p class="mt-1 text-xs text-muted-foreground">
								{$_('onboarding.feature_submit_desc')}
							</p>
						</div>
						<div class="rounded-xl border border-border p-4">
							<div class="mb-2 text-2xl">💬</div>
							...
							<p class="mt-1 text-xs text-muted-foreground">
								{$_('onboarding.feature_community_desc')}
							</p>
						</div>
						<div
							class="relative rounded-xl border-2 border-purple-400 bg-purple-50 p-4 dark:bg-purple-950/40"
						>
							<span
								class="absolute right-2 top-2 rounded-full bg-purple-500 px-2 py-0.5 text-[10px] font-bold text-white"
								>Phổ biến</span
							>
							<div class="mb-2 text-2xl">🎮</div>
							<p class="font-semibold">{$_('onboarding.feature_battlepass')}</p>
							<p class="mt-1 text-xs text-muted-foreground">
								{$_('onboarding.feature_battlepass_desc')}
							</p>
							<a
								href="/battlepass"
								target="_blank"
			...
			{:else if step === 6}
				...
				<div class="space-y-4 text-center">
					<div
						class="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-indigo-100 dark:bg-indigo-950"
					>
			...
			{:else if step === 7}
				...
				<div class="space-y-4">
					<div
						class="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-green-100 dark:bg-green-950"
					>
					...
					<div
						class="rounded-lg border border-amber-300 bg-amber-50 px-4 py-3 text-sm font-medium text-amber-800 dark:border-amber-700 dark:bg-amber-950/40 dark:text-amber-200"
					>
			...
			{:else if step === 8}
				...
				<div class="space-y-4">
					...
					<!-- Supporter card -->
					<div
						class="rounded-xl border-2 border-yellow-400 bg-gradient-to-br from-yellow-50 to-pink-50 p-4 dark:from-yellow-950/30 dark:to-pink-950/30"
					>
						<div class="flex items-start justify-between">
							<div>
								<p class="font-bold text-yellow-700 dark:text-yellow-300">
									{$_('onboarding.support_supporter_title')}
								</p>
								<p class="text-xs text-muted-foreground">
									{$_('onboarding.support_supporter_price')}
								</p>
							</div>
					...
					<div class="grid grid-cols-2 gap-3">
						<div class="rounded-xl border border-border p-3">
							...
							<p class="text-xs text-yellow-600 dark:text-yellow-400">
								{$_('onboarding.support_queue_price')}
							</p>
							<p class="mt-1 text-xs text-muted-foreground">
								{$_('onboarding.support_queue_desc')}
							</p>
						...
						<div class="rounded-xl border border-border p-3">
							...
							<p class="text-xs text-yellow-600 dark:text-yellow-400">
								{$_('onboarding.support_clan_price')}
							</p>
			...
			{:else}
				...
				<div class="space-y-4 text-center">
					...
					<div
						class="rounded-xl border border-indigo-200 bg-indigo-50 p-4 text-left dark:border-indigo-800 dark:bg-indigo-950/30"
					>
						<div class="mb-2 flex items-center gap-2">
							...
							<p class="text-sm font-semibold text-indigo-800 dark:text-indigo-200">
								{$_('onboarding.done_discord_title')}
							</p>
						</div>
