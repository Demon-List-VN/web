<script lang="ts">
	...
	function buildRandomPreviewLevels(): PreviewLevel[] {
		...
		return levels.sort((left, right) => left.top - right.top)
			.map((
				level,
				index
			) => ({
...
<div class="custom-list-promo" data-nosnippet>
  <div class="promo-content">
    ...
    <p class="promo-desc">
      Tạo bảng xếp hạng level của riêng bạn, thêm cộng tác viên và chia sẻ giao
      diện riêng cho cộng đồng.
    </p>
      ...
      <div class="preview-body">
        ...
        <div class="preview-levels">
          {#each previewLevels as level}
            <div
              class:preview-level-row-faded={level.faded}
              class="preview-level-row"
            >
