<script lang="ts">
	...
	export let onAddRewardClick:
		| ((tier: number, isPremium: boolean) => void)
		| null = null;
    ...
    <div class="flex gap-4">
      {#each Array(maxTierToShow) as _, i}
        ...
        <div class="flex w-20 items-center justify-center">
          <div
            class="
              tier-number flex h-10 w-10 items-center justify-center rounded-full text-sm font-bold transition-all {isUnlocked
