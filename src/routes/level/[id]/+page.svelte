	...
	function getOfficialLevelLists(level: any): StarredListEntry[] {
		...
		if (level.dlTop != null) {
			if (level.isChallenge) {
				officialLists.push({
					...
					description: 'Official GDListHub challenge list.',
				...
				officialLists.push({
					...
					description: 'Official GDListHub platformer list.',
					updated_at: updatedAt,
					mode: 'top',
					isPlatformer: true,
					isOfficial: true,
				...
				officialLists.push({
					...
					title: 'Classic List',
					description:
						'Official GDListHub classic demon list.',
					updated_at: updatedAt,
					mode: 'rating',
					isPlatformer: false,
					isOfficial: true,
		...
		if (level.flTop != null) {
			officialLists.push({
				...
				slug: 'fl',
				title: 'Featured List',
				description: 'Official GDListHub featured list.',
				updated_at: updatedAt,
				mode: 'top',
