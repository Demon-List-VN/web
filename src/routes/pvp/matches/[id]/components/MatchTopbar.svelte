<script lang="ts">
	...
	export let levelChangeUsed = false;
	export let levelChangeRequestedBySelf = false;
	export let levelChangeButtonLabel = '';
	export let canRequestBanPickAbort = false;
	export let banPickAbortRequestedBySelf = false;
	export let banPickAbortButtonLabel = '';
	...
	{#if loggedIn}
		<div class="topbar-actions">
			...
			{#if canRequestBanPickAbort}
				<Button
					variant="destructive"
					disabled={Boolean(actionLoading) || loading || banPickAbortRequestedBySelf}
