...
{#if showModal}
  ...
  <div class="modal-backdrop" on:click={() => (showModal = false)}>
    ...
    <div class="modal-card" on:click|stopPropagation>
      <div
        class="card-wrap"
        class:dark={data.template === 1}
        class:light={data.template === 2}
        class:gold={data.template === 3}
      >
        ...
        <div class="card-bottom">
          <div class="player-info">
            ...
            {#if data.clanTag}
              <span
                class="clan-tag"
                style={`background-color: ${data.clanTagBg || '#555'}; color: ${
                    data.clanTagText || '#fff'
                };`}
              >
                {data.clanTag}
              </span>
