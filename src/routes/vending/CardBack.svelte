...
<div
  class="card-back-container"
  class:fill={fillContainer}
  style={scale !== 1 ? 'aspect-ratio: 245 / 155.48;' : ''}
>
  <div
    ...
    <div class="card-back">
      ...
      <div class="main-content">
        <div class="top-sections">
          ...
          <div class="section">
            <p>
              <strong>Sử dụng thẻ</strong><br />
              Quét thẻ này thông qua giao thức NFC hoặc quét mã QR bằng camera.
            </p>
          </div>
          <div class="section">
            <p>
        ...
        <div class="bottom-sections">
          ...
          <div class="qr-column">
            ...
            <p class="card-id">
              ID: {cardID || '00000000-0000-0000-0000-000000000000'}
            </p>
          </div>
        </div>
      </div>
