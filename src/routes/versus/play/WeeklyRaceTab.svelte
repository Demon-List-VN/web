        ...
        <Tabs.Content value="standings">
          ...
          {:else}
            {#if userRaceRow}
              ...
              <div
                class="weekly-race-user-result"
                aria-label={$_('pvp.weekly_race.your_result')}
              >
                <span>
                  {#if userRaceRow.rank}
                    #{userRaceRow.rank}
              ...
              >
                <div class="leaderboard-row leaderboard-head" role="row">
                  ...
                  <span role="columnheader">{
                    $_('pvp.leaderboard.player')
                  }</span>
                  <span role="columnheader">{
                    $_('pvp.weekly_race.points')
                  }</span>
                  <span role="columnheader">{
                    $_('pvp.weekly_race.winrate')
                  }</span>
                </div>
            ...
            <div class="weekly-race-history">
              ...
              {#if weeklyRace.previousLeaderboard.length === 0}
                <div class="empty-state compact">
                  {$_('pvp.weekly_race.history_empty')}
                </div>
              {:else}
