...
<svelte:head>
  ...
  <meta
    ...
    content={$_('pvp.landing.meta_description')}
  />
...
<main class="versus-landing">
  ...
  <section
    class="versus-features"
    aria-label={$_('pvp.landing.features_label')}
  >
  ...
  <section class="versus-info-band" id="leaderboard">
    ...
    <a href="/versus/play">{$_('pvp.landing.rank_cta')} <ArrowRight
        class="h-4 w-4"
      /></a>
  </section>
