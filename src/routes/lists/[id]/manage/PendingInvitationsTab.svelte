    ...
    <section class="card highlightCard">
      <header class="cardHead cardHeadSplit">
        <div class="cardHeadCopy">
          <h2 class="cardTitle">
            {$_('custom_lists.manage.collaboration.pending_your_title')}
          </h2>
          <p class="hint">
            {$_('custom_lists.manage.collaboration.pending_your_hint')}
          </p>
        </div>
        <Badge
          class="roleBadge"
          variant={pendingInvitation.role === 'admin' ? 'default' : 'outline'}
        >
        ...
        <div class="memberMain">
          <Avatar.Root class="h-11 w-11 flex-shrink-0">
            ...
            >
              {
                getAvatarFallback(
                    pendingInvitation.invitedByData ?? { uid: pendingInvitation.invitedBy }
                )
              }
            </Avatar.Fallback>
          </Avatar.Root>
      ...
      <div class="formActions">
        <Button
          on:click={acceptPendingInvitation}
        ...
        <Button
          variant="outline"
          on:click={rejectPendingInvitation}
          disabled={savingCollaboration}
        >
    ...
    <section class="card">
      <header class="cardHead cardHeadSplit">
        <div class="cardHeadCopy">
          ...
          <p class="hint">
            {$_('custom_lists.manage.collaboration.pending_hint')}
          </p>
        </div>
      ...
      {:else}
        <p class="emptyRow">
          {$_('custom_lists.manage.collaboration.pending_empty')}
        </p>
      {/if}
    </section>
  {/if}
