<script lang="ts">
	...
	export let uploadAsset: (
		asset: 'banner' | 'favicon' | 'logo',
		file: File
	) => Promise<string | null | undefined> = async () => null;
	...
	function inferAssetInputMode(value: string | null | undefined): AssetInputMode {
		...
		return value.startsWith(`${CUSTOM_LIST_CDN_BASE_URL}/custom-lists/`)
			? 'upload'
			: 'link';
	}
    ...
    <div class="formGrid">
      ...
      <div class="field">
        <label for="list-background-color">{
          $_('custom_lists.detail.edit.background_color_label')
        }</label>
        <div class="colorFieldRow">
          ...
          <Button
            variant="ghost"
            size="sm"
            on:click={() => resetThemeColor('backgroundColor')}
          >
            {$_('general.reset')}
          </Button>
        </div>
        <p class="hint">
          {$_('custom_lists.detail.edit.background_color_hint')}
        </p>
      </div>
      <div class="field">
        <label for="list-border-color">{
          $_('custom_lists.detail.edit.border_color_label')
        }</label>
        <div class="colorFieldRow">
          <input
            class="nativeColorInput"
          ...
          <Button
            variant="ghost"
            size="sm"
            on:click={() => resetThemeColor('borderColor')}
          >
            {$_('general.reset')}
          </Button>
        </div>
      ...
      <div class="field">
        <label for="list-banner-asset-mode">{
          $_('custom_lists.detail.edit.banner_url_label')
        }</label>
        <div class="assetControlRow">
          <div class="assetModeTrigger">
            ...
            >
              <Select.Trigger
                aria-label={$_('custom_lists.detail.edit.banner_url_label')}
              >
                <Select.Value
                  placeholder={getAssetModeLabel(bannerAssetMode)}
                />
              </Select.Trigger>
              <Select.Content>
          ...
          {#if bannerAssetMode === 'upload'}
            <div class="assetAction">
              <Button
                variant="outline"
                size="sm"
                on:click={openBannerFilePicker}
                disabled={uploadingThemeAsset === 'banner'}
              >
                {
        ...
        <p class="hint">
          {
            bannerAssetMode === 'upload'
            ? $_('custom_lists.detail.edit.asset_upload_hint')
            : $_('custom_lists.detail.edit.banner_url_hint')
          }
        </p>
      </div>
      <div class="field">
        <label for="list-favicon-asset-mode">{
          $_('custom_lists.detail.edit.favicon_url_label')
        }</label>
        <div class="assetControlRow">
          <div class="assetModeTrigger">
            <Select.Root
            ...
            >
              <Select.Trigger
                aria-label={$_('custom_lists.detail.edit.favicon_url_label')}
              >
                <Select.Value
                  placeholder={getAssetModeLabel(faviconAssetMode)}
                />
              </Select.Trigger>
              <Select.Content>
                <Select.Item value="upload">{
          ...
          {#if faviconAssetMode === 'upload'}
            <div class="assetAction">
              <Button
                variant="outline"
                size="sm"
                on:click={openFaviconFilePicker}
                disabled={uploadingThemeAsset === 'favicon'}
              >
                {
        ...
        <p class="hint">
          {
            faviconAssetMode === 'upload'
            ? $_('custom_lists.detail.edit.asset_upload_hint')
            : $_('custom_lists.detail.edit.favicon_url_hint')
          }
        </p>
        {#if getFaviconPreviewUrl()}
          <div class="assetPreview assetPreviewFavicon">
            <img
              src={getFaviconPreviewUrl()}
              alt=""
              loading="lazy"
              decoding="async"
            />
      ...
      <div class="field">
        <label for="list-logo-asset-mode">{
          $_('custom_lists.detail.edit.logo_url_label')
        }</label>
        <div class="assetControlRow">
          <div class="assetModeTrigger">
            <Select.Root
            ...
            >
              <Select.Trigger
                aria-label={$_('custom_lists.detail.edit.logo_url_label')}
              >
          ...
          {#if logoAssetMode === 'upload'}
            <div class="assetAction">
              <Button
                variant="outline"
                size="sm"
                on:click={openLogoFilePicker}
                disabled={uploadingThemeAsset === 'logo'}
              >
                {
        ...
        <p class="hint">
          {
            logoAssetMode === 'upload'
            ? $_('custom_lists.detail.edit.asset_upload_hint')
            : $_('custom_lists.detail.edit.logo_url_hint')
          }
        </p>
